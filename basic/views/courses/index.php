            ...
            <div class="col-md-4 col-sm-6">
                <div class="thumbnail">
                    ...
                    <div class="caption">
                        ...
                        <p><?= $item->subject." [".$item->examType."] / ".$item->teacher ?></p>
                        ...
                        <?php
                            if(Yii::$app->user->isGuest)
                                ...
                                if(Yii::$app->user->identity->isAdmin()){
                                    ...
                                    if(count(\app\models\BoughtCourses::find()->where(['course' => $item->id])->andWhere(['user' => Yii::$app->user->identity->getId()])->all()) > 0){
                                        $action = '/courses/view';
                                        $param = "id";
                                        $label = "Открыть";
                                    }else{
